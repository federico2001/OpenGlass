...
| [`langchain-integration/`](langchain-integration/) | The same idea for a LangChain agent: registering [`openglass-langchain`](../langchain-py)'s callback handler is the only OpenGlass-specific line, and only the risky tool call gets witnessed. |
