...
export const validDocs: Record<string, Record<string, unknown>> = {
  ...
  integration_requests: {
    _id: `irq_${U}`, frameworkName: "Haystack", frameworkUrl: "https://haystack.deepset.ai/",
    note: "We use Haystack pipelines for retrieval.", ownerId: `own_${U}`, requesterEmail: "alice@example.com",
